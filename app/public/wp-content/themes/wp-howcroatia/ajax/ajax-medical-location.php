...
function medical_location(){
	...
	if( isset( $_POST['medicalLocation'] ) )
		$args['tax_query'] = array(
			array(
				'taxonomy' => 'location-medical',
				'field' => 'id',
				'terms' => $_POST['medicalLocation'],
			)
		);
...
add_action('wp_ajax_locationMedicalFilter', 'medical_location'); // wp_ajax_{ACTION HERE} 
add_action('wp_ajax_nopriv_locationMedicalFilter', 'medical_location');
